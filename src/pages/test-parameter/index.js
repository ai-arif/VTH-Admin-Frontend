...
export default function TestParameter() {
  ...
  const { tests, status, parameterList, subParameterList, allAdditionalFields } = useSelector((state) => state.test);
  ...
  const handleSubParameter = async () => {
    ...
    if (type == "text") {
      (newData.isInputField = true), (newData.title = text), (newData.test_parameter = selectedParameter.id);
    } else {
      (newData.isInputField = false), (newData.title = check), (newData.test_parameter = selectedParameter.id);
    }
      ...
      <div className="row">
        ...
        <div className="col-4">
                ...
                <li key={index} className="list-group-item mt-3">
                  ...
                  <div className="d-flex justify-content-between align-items-center mt-4">
                    <div className="d-flex align-items-center gap-4">
                      <MdOutlineDeleteForever type="button" className="" size={23} color="red" onClick={() => handleParameterDelete(param._id)} />
                      <CiEdit
                        type="button"
                        data-bs-toggle="modal"
                        data-bs-target="#updateTestParam"
                        onClick={() => {
          ...
          <div className="d-flex align-items-center gap-3 mt-3">
            <input className="form-control" placeholder="Enter parameter" value={inputValue} onChange={handleInputChange} />

            <button className="btn btn-primary text-white" onClick={handleAddButtonClick}>
              Add
            </button>
          </div>
        </div>
          ...
          <div className="col-4">
            ...
            <div className="d-flex justify-content-center my-3">
              <div className="btn-group" role="group">
                <button
                  className={`btn text-white ${activeTabSub === "subParams1" ? "btn-primary" : "btn-outline-primary border"}`}
                  onClick={() => {
                    setType("text");
                    setCheck("");
                    setActiveTabSub("subParams1");
                  }}
                >
                  Text
                </button>
                <button
                  className={`btn text-white ${activeTabSub === "subParams2" ? "btn-primary" : "btn-outline-primary border"}`}
                  onClick={() => {
                    setType("check");
                    setText("");
                    setActiveTabSub("subParams2");
                  }}
                >
                  Check item
                </button>
            ...
            {activeTabSub === "subParams1" && (
              <div>
                          ...
                          <div className="d-flex justify-content-between">
                            <div className="w-100 d-flex gap-3 mt-4">
                              ...
                              <CiEdit
                                type="button"
                                data-bs-toggle="modal"
                                data-bs-target="#updateTestSubParam"
                                onClick={() => {
                                ...
                                color="gray"
                              />
                              <MdOutlineDeleteForever type="button" size={23} color="red" onClick={() => handleSubParameterDelete(param._id)} />
                            </div>
                            <button
                              className="btn border"
                              onClick={() => {
                ...
                <div className="d-flex gap-3 mt-3">
                  <input className="form-control w-75" placeholder="Enter sub parameter name" value={text} onChange={(e) => setText(e.target.value)} />
                  <button className="btn btn-sm btn-primary text-white" onClick={handleSubParameter}>
                    Add
                  </button>
                </div>
              </div>
            ...
            {activeTabSub === "subParams2" && (
              <div>
                          ...
                          <div className="d-flex justify-content-between">
                            <div className="w-100 d-flex gap-3 mt-4">
                              ...
                              <CiEdit
                                type="button"
                                data-bs-toggle="modal"
                                data-bs-target="#updateTestSubParam2"
                                onClick={() => {
                                  setSelectedSubParameter({
                                    subParameterName: param.title,
                                    id: param._id,
                ...
                <div className="d-flex gap-3 mt-3">
                  <input className="form-control w-100" placeholder="Check item name" value={check} onChange={(e) => setCheck(e.target.value)} />
                  <button className="btn btn-sm btn-primary text-white" onClick={handleSubParameter}>
                    Add
                  </button>
                </div>
          ...
          <div className="col-4">
            ...
            {activeTab === "additional1" && (
              <div>
                          ...
                          <li className="list-group-item mt-3 d-flex justify-content-between">
                            ...
                            <div className="d-flex gap-3 mt-4">
                              <CiEdit
                                type="button"
                                data-bs-toggle="modal"
                                data-bs-target="#updateAdditional"
                                onClick={() => {
                ...
                <div className="d-flex gap-3 mt-3">
                  <input className="form-control w-100" placeholder="Text value" value={text2} onChange={(e) => setText2(e.target.value)} />
                  <button
            ...
            {activeTab === "additional2" && (
              <div>
                ...
                <div className="d-flex gap-3 mt-3">
                  <input className="form-control w-100" placeholder="Check item name" value={text2} onChange={(e) => setText2(e.target.value)} />
                  <button
                    className="btn btn-sm btn-primary text-white"
                    onClick={(param) => {
                      handleAdditionalParams(param._id);
