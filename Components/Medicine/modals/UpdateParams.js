...
import { fetchMedicineParams, updateMedicineParamsData } from "../../../features/medicineParam/MedicineParamsSlice";
...
const UpdateParams = ({ existingData }) => {
  ...
  const onSubmit = async (params) => {
    try {
      ...
      toast.error("An error occurred while updating params. Please try again later.");
      console.error(error);
    }
  };
  ...
  return (
    <div>
      <div className="modal fade" id="updateParams" tabIndex="-1" aria-labelledby="updateParamsLabel" aria-hidden="true">
