...
const UpdateTestSubParamModal2 = ({ existingTestParamsName, handleSubmit }) => {
    ...
    return (
        <div>
            <div className="modal fade" id="updateTestSubParam2" tabIndex="-1" aria-labelledby="updateTestLabel" aria-hidden="true">
...
export default UpdateTestSubParamModal2;
