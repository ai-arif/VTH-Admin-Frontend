...
const UpdateAdditionalModal1 = ({ existingTestParamsName, handleSubmit }) => {
    ...
    return (
        <div>
            <div className="modal fade" id="updateAdditional" tabIndex="-1" aria-labelledby="updateTestLabel" aria-hidden="true">
...
export default UpdateAdditionalModal1;
