...
const colors = [
    '#FF8042', '#00C49F', '#FFBB28', '#0088FE', '#4CAF50',
    '#2196F3', '#FFEB3B', '#FF5722', '#9C27B0', '#FF9800',
    '#009688', '#3F51B5', '#E91E63', '#CDDC39', '#607D8B', '#795548'
];
                ...
                <ResponsiveContainer width="100%" height="100%">
                    ...
                    >
                        ...
                        {Object?.keys(formattedMonthlyData?.[0] || {})?.map((species, index) => {
                            if (species === "month") return null; // Skip the 'month' field
